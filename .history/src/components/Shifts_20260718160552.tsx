                ...
                {shifts.map((shift) => {
                  ...
                  return (
                    <tr key={shift.id} className="hover:bg-gray-50/50 dark:hover:bg-[#1b1b18]/40 transition">
                      ...
                      <td className="px-6 py-4">shift.status
                        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${ === 'open'
